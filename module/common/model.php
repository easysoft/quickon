<?php
/**
 * The model file of common module of QuCheng.
 *
...
class commonModel extends model
{
    ...
    public static function printUserBar()
    {
        ...
        if(isset($app->user))
        {
            ...
            echo html::avatar($app->user, '', 'avatar-circle', '', 'div', 43, '30%', '40%');
            echo '</a>';
        }
    }
    ...
    public static function printAboutBar()
    {
        ...
        echo '<li>' . html::a(helper::createLink('misc', 'about'), "<i class='icon icon-about'></i> " . $lang->aboutQuCheng, '', "class='about iframe' data-width='1050' data-headerless='true' data-backdrop='true' data-keyboard='true' data-class='modal-about'") . '</li>';
    ...
    public static function printBreadMenu($moduleName, $position)
    {
        ...
        echo '<li>' . html::a(helper::createLink('my', 'index'), $lang->qucheng) . '</li>';
        if($moduleName != 'index')
        {
...
EOT;
    ...
    public static function printDuration($seconds, $format = 'y-m-d-h-i-s')
    {
        ...
        if(strpos($format, 'd') !== false)
        {
            ...
            if($days) $duration .= $days . $lang->day;
        }
    ...
    public static function httpWithHeader($url, $data = null, $options = array(), $headers = array())
    {
        ...
        $logFile = $app->getLogRoot() . 'curl.'. date('Ymd') . '.log.php';
     ...
     * @return string
     */
    public static function http($url, $data = null, $options = array(), $headers = array(), $dataType = 'data', $timeout = 30)
    {
        global $lang, $app;
