...
<head>
  ...
  <?php
  echo html::title($title . ' - ' . $lang->qucheng);
  js::exportConfigVars();
  ...
  else
  {
      ...
      if(!file_exists($this->app->getThemeRoot() . 'default/' . $this->cookie->lang . '.' . $this->app->clientTheme . '.css')) $minCssFile = $defaultTheme . 'en.' . $this->app->clientTheme . '.css';
