module gitlab.zcorp.cc/pangu/cne-api
...
require (
	...
	gitlab.zcorp.cc/pangu/app-sdk v0.0.0-00010101000000-000000000000
...
replace gitlab.zcorp.cc/pangu/app-sdk => ./staging/src/gitlab.zcorp.cc/pangu/app-sdk
