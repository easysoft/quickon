...
class baseRouter
{
   ...
   //------ 客户端环境有关的函数(Client environment related functions) ------//
    ...
    public function startSession()
    {
        ...
        $sessionLife = isset($this->config->sessionLife) ? $this->config->sessionLife : 3600;
        ...
        session_set_cookie_params($sessionLife, $this->config->webRoot, '', $this->config->cookieSecure, true);
        ...
        setcookie($sessionName, $this->sessionID, time() + $sessionLife, '', '', $this->config->cookieSecure, true);
