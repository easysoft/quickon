...
<div id="mainContent" class="main-row">
  <div class="main-col main-content">
    ...
    <table class="table table-bordered text-center">
      <tr>
        <th class="hidden"><?php echo $lang->system->dbAlias?></th>
      ...
      <tr>
        ...
        <td><?php echo html::commonButton($lang->system->login, "data-db-name='{$db->name}' data-namespace='{$db->namespace}'", 'db-login btn btn-link');?></td>
      <tr>
      <?php endforeach;?>
    </table>
  </div>
