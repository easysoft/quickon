    ...
    <div class="cell">
      <div class="main-header">
        ...
        <div class="btn-group dropdown pull-right">
          <?php echo html::a(helper::createLink('instance', 'install', "id={$cloudApp->id}", '', true), $lang->instance->install, '', "class='iframe btn btn-primary' title='{$lang->instance->install}' data-width='480' data-app='space'");?>
        </div>
      </div>
