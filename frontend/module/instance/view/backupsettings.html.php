  ...
  <div class='center-block'>
    ...
    <div>
      <form id='backupSettingForm' method='post' class="cell not-watch load-indicator main-form">
        <h4>
          <?php echo html::checkbox('autoBackup', array('true' => $lang->instance->backup->enableAutoBackup), $backupSettings->autoBackup ? 'true' : '');?>
        </h4>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class='required w-250px'>
                <div class='input-group'>
                  <?php echo html::select('cycleDays', $lang->instance->backup->cycleList, $backupSettings->cycleDays, "class='form-control' maxlength='20'");?>
                </div>
              </td>
              <td></td>
            </tr>
            <tr>
              ...
              <td class='required'>
                <div class='input-group'>
                  <?php echo html::number('keepDays', $backupSettings->keepDays, "class='form-control' maxlength='2' min='1' max='30'");?>
                </div>
